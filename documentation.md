...
**First Impressions and Feedback:**
Initially, I hoped that adding white noise to the music would have an effect similar to disturbed radio or television signals. Unfortunately, I found that a much more finely tuned amount of noise was needed to achieve this effect rather than a regular, unexciting annoyance. Moreover, the concept did not work for very high polluted areas because then I experienced a constant noise in the background next to the music, which was alarming and annoying but not as artistic and informative as I wished.
